...
class MinimizedDFAPage extends StatelessWidget {
  const MinimizedDFAPage({super.key});

  @override
  Widget build(BuildContext context) {
    final minimizedDFA = _buildProvidedDFA();
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Minimized DFA - Hopcroft\'s Algorithm',
        ...
        child: Column(
          ...
          children: [
            DFADiagramWidget(
                ...
                customPositions: _buildPositions(minimizedDFA)),
            const SizedBox(height: 12),
            _buildLegend(context),
            const SizedBox(height: 24),
            _buildInfoCard(context, minimizedDFA),
            const SizedBox(height: 24),
            _buildTransitionTable(context, minimizedDFA),
            const SizedBox(height: 24),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            const Text(
              'Hopcroft\'s Algorithm minimizes a DFA by merging equivalent states while preserving the language.',
            ...
            _buildBulletPoint('Produces minimal DFA'),
            _buildBulletPoint('Merges equivalent states'),
            _buildBulletPoint('Maintains language recognition'),
            _buildBulletPoint('Time complexity O(n log n)'),
          ],
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: Text(
        ...
        style: TextStyle(
          ...
          color: color ?? (isHeader ? Colors.orange.shade900 : Colors.black),
